...
public class Invoice
{
    ...
    internal void UpdateProductKeyCodes(ProbotContext context, IEnumerable<ProductKey> productKeys)
    {
    ...
    public void UpdateOrderData(ProbotContext context, OrderStatus orderStatus)
    {
        OrderStatus = orderStatus;
        context.Entry(this).Property(i => i.OrderStatus).IsModified = true;
    }
    
    public void UpdateTransactionData(ProbotContext context, Transaction transaction)
    {
