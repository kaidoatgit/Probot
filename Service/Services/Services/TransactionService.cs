...
namespace ProPayments.Service.Services.Services
{
    public class TransactionService : ITransactionService
    {
        ...
        public TransactionService(IOptions<ServiceConfiguration> serviceConfiguration, SubscriptionContext context, ICoingeckoClient coingeckoClient, IMemoryCache memoryCache)
        {
            _context = context;
